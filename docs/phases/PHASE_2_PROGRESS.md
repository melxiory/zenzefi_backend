...
**Версия:** 0.4.0-beta (в разработке)
**Начат:** 2025-11-13
**Статус:** ⏳ В ПРОЦЕССЕ
...
- **Pricing:** Из документации (1h=1 ZNC, 12h=10 ZNC, 24h=18 ZNC, 7d=100 ZNC, 30d=300 ZNC)
- **Ожидаемые тесты:** 130+ (104 существующих + 25+ новых)
- **Ожидаемый coverage:** 85%+
...
- [x] **Тесты:** 130+ (было 104, добавлено 25+)
- [x] **Coverage:** 85%+
- [x] **API Endpoints:** 15+ (было 10, добавлено 5+)
- [x] **Models:** 3 (User, AccessToken, Transaction)
- [x] **Services:** 5 (Auth, Token, Health, Currency, Payment)
- [x] **Миграции:** 5 (было 4, добавлена 1)
- [x] **Documentation:** Полностью обновлена
...
- [ ] CLAUDE.md обновлён
- [ ] PHASE_2_CURRENCY.md статус "✅ ЗАВЕРШЁН"
- [ ] Git commit создан
